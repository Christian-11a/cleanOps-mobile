...
export function SecurityView({ 
  ...
  const themeAccent = accentColor || C.blue600;
        ...
        <ScrollView contentContainerStyle={st.scroll}>
          ...
          <View style={[st.card, { backgroundColor: C.surface, borderColor: C.divider }]}>
            ...
            <View style={[st.row, { borderTopWidth: 1, borderTopColor: C.divider }]}>
              <View style={[st.iconWrap, { backgroundColor: `${themeAccent}15` }]}>
        ...
        <View style={st.modalOverlay}>
          <View style={[st.modalContent, { backgroundColor: C.surface }]}>
            ...
            <View style={st.modalActions}>
              ...
              <TouchableOpacity
                style={[st.modalBtn, { backgroundColor: themeAccent }]}
      ...
      <Modal visible={policyModal} transparent animationType="fade">
        <View style={st.modalOverlay}>
          <View style={[st.modalContent, { backgroundColor: C.surface, maxHeight: '80%' }]}>
              ...
              {privacyPolicyContent || (
                <>
                  <Text style={[st.policyPara, { color: C.text2 }]}>
                    ...
                    We collect information necessary for service fulfillment, including your name, email, phone number, and home address.
                  </Text>
                  <Text style={[st.policyPara, { color: C.text2 }]}>
                    <Text style={{ fontWeight: '800' }}>2. Home & Pet Info: </Text>
                    To provide accurate cleaning services, we store data about your home (size, rooms) and any pets.
                  </Text>
                  <Text style={[st.policyPara, { color: C.text2 }]}>
                    <Text style={{ fontWeight: '800' }}>3. Data Sharing: </Text>
                    Your address is shared with the assigned cleaner only.
                  </Text>
                </>
              )}
            </ScrollView>
            ...
            <TouchableOpacity
              style={[st.modalBtn, { backgroundColor: themeAccent, marginTop: 20 }]}
